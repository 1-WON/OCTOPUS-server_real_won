...
class SystemLogGrid extends Component {
  ...
  downloadExcel = () => {
    this.gridRef.current.getInstance().export('xlsx', {fileName: '시스템 로그  리스트'});
  }
        ...
        <div className="animated fadeIn">
          <Row>
            <Col xs="12" lg="12">
              <Card style={{marginBottom: 15 + 'px'}}>
                <CardHeader>
                  <Form inline>
                    ...
                    <FormGroup className="pr-2">
                      <Input type="text" id="exampleInputEmail2" placeholder="port 입력" style={{width: 180 + 'px'}}/>
                    </FormGroup>
                    <FormGroup className="pr-2">
                      <Input type="text" id="exampleInputEmail2" placeholder="이벤트 입력" style={{width: 180 + 'px'}}/>
                    </FormGroup>
              ...
              <Card>
                <CardHeader>
                  <i className="fa fa-align-justify"/>시스템 로그
                </CardHeader>
                {this.renderContent()}
              </Card>
            </Col>
